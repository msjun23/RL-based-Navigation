...
if __name__ == "__main__":
    ...
    # world_name = "BARN_ours/world_%d.world" %(args.world_idx)
    ...
    while compute_distance(goal_coor, curr_coor) > 1 and not collided and curr_time - start_time < 100 and curr_coor[1] <= 9.0:
        curr_time = rospy.get_time()
        pos = gazebo_sim.get_model_state().pose.position
        curr_coor = (pos.x, pos.y)
